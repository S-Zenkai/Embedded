...
static void LED_GPIO_Config(void)
{
	...
	LED_GPIO_InitStruct.GPIO_Pin = ((uint16_t)0x0020);
	LED_GPIO_InitStruct.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), &LED_GPIO_InitStruct);

	 
	LED_GPIO_InitStruct.GPIO_Pin = ((uint16_t)0x0001);
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), &LED_GPIO_InitStruct);

	 
	LED_GPIO_InitStruct.GPIO_Pin = ((uint16_t)0x0002);
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), &LED_GPIO_InitStruct);

	 
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0002)), GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0001)), GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0020));
}
