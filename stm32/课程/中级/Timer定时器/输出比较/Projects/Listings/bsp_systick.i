# 1 "..\\Drivers\\BSP\\SYSTICK\\bsp_systick.c"

# 1 "..\\Drivers\\BSP\\SYSTICK\\bsp_systick.h"
...
# 4 "..\\Drivers\\BSP\\SYSTICK\\bsp_systick.h"
...
# 3 "..\\Drivers\\BSP\\SYSTICK\\bsp_systick.c"
# 1 "..\\Drivers\\BSP\\SYS\\bsp_sys.h"
# 4 "..\\Drivers\\BSP\\SYS\\bsp_sys.h"
...
# 4 "..\\Drivers\\BSP\\SYSTICK\\bsp_systick.c"

static uint16_t  g_fac_us = 0;       

 
# 33 "..\\Drivers\\BSP\\SYSTICK\\bsp_systick.c"
...
void SysTick_Init(uint16_t sysclk)
{
	...
	g_fac_us = sysclk / 8;
# 58 "..\\Drivers\\BSP\\SYSTICK\\bsp_systick.c"
}

# 114 "..\\Drivers\\BSP\\SYSTICK\\bsp_systick.c"
...
{
    uint32_t temp;
    ((SysTick_Type *) ((0xE000E000) + 0x0010))->LOAD = nus * g_fac_us;  
    ((SysTick_Type *) ((0xE000E000) + 0x0010))->VAL = 0x00;             
    ((SysTick_Type *) ((0xE000E000) + 0x0010))->CTRL |= 1 << 0 ;        
