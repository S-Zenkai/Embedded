# 1 "..\\Drivers\\CMSIS\\system_stm32f10x.c"
...
# 65 "..\\Drivers\\CMSIS\\system_stm32f10x.c"
...
# 161 "..\\Drivers\\CMSIS\\system_stm32f10x.c"
...
# 188 "..\\Drivers\\CMSIS\\system_stm32f10x.c"
...
# 249 "..\\Drivers\\CMSIS\\system_stm32f10x.c"
...
# 399 "..\\Drivers\\CMSIS\\system_stm32f10x.c"
      break;
...
static void SetSysClock(void)
{
# 431 "..\\Drivers\\CMSIS\\system_stm32f10x.c"
  SetSysClockTo72();
...
# 490 "..\\Drivers\\CMSIS\\system_stm32f10x.c"

# 979 "..\\Drivers\\CMSIS\\system_stm32f10x.c"
...
static void SetSysClockTo72(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->ACR &= (uint32_t)((uint32_t)~((uint8_t)0x07));
...
# 1052 "..\\Drivers\\CMSIS\\system_stm32f10x.c"
