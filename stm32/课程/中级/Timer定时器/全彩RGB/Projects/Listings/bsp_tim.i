# 1 "..\\Drivers\\BSP\\TIM\\bsp_tim.c"
# 1 "..\\Drivers\\BSP\\TIM\\bsp_tim.h"
...
# 2 "..\\Drivers\\BSP\\TIM\\bsp_tim.c"
# 1 "..\\Drivers\\BSP\\LED\\bsp_led.h"



# 5 "..\\Drivers\\BSP\\LED\\bsp_led.h"



 
# 17 "..\\Drivers\\BSP\\LED\\bsp_led.h"
...
void Timer_Init(void)
{
	...
	TIM_InternalClockConfig(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00))); 
	...
	TIM_TimeBaseInit(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)), &TIM_TimeBaseInitStructure);
	 
	 
	TIM_ClearFlag(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)), ((uint16_t)0x0001));  
	 
	NVIC_Configuration();
	TIM_ITConfig(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)), ((uint16_t)0x0001), ENABLE);
...
{
	while (TIM_GetITStatus(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)), ((uint16_t)0x0001)))
	{
		value++;
		TIM_ClearFlag(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)), ((uint16_t)0x0001));
		((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->ODR ^= ((uint16_t)0x0001);
	}
}
