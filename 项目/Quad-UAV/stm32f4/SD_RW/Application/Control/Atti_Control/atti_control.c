...
{
    __IO Axis_State_t *_axis_state = atti_control_ctx->flight_control_state->control_state;
    __IO Flight_Control_State_t *_flight_state = atti_control_ctx->flight_control_state;
